...
@section('dashboard-title', 'Super Admin - Create Service Type')

@section('content')
    <div class="card border-0 shadow-sm" style="max-width: 800px; margin: 0 auto;">
        <div class="card-body">
            <h2 class="mb-4 fw-bold">Create New Service Type</h2>

            <form method="POST" action="{{ route('super-admin.service-types.store') }}">
                @csrf
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle me-1"></i>Create Service Type
                    </button>
                </div>
            </form>
        </div>
