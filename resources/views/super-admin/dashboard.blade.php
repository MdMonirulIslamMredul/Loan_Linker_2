...
@section('title', ucwords(str_replace('_', ' ', auth()->user()->role ?? 'Admin')) . ' Dashboard')
@section('dashboard-title', ucwords(str_replace('_', ' ', auth()->user()->role ?? 'Admin')) . ' Dashboard')
...
<div class="row g-3 mb-4">
    ...
    {{-- <div class="col-6 col-md-4 col-lg-2">
            <a href="{{ route('super-admin.admins.create') }}" class="text-decoration-none">
    <div class="card border-0 shadow-sm text-center p-3 dashboard-count-card">
        <div class="d-flex align-items-center justify-content-center gap-2">
            <i class="bi bi-person-plus-fill text-success count-icon"></i>
            <div class="fs-4 fw-bold">New</div>
        </div>
        <div class="text-muted small">Create Admin</div>
    </div>
    </a>
</div> --}}
