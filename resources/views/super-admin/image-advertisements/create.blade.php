...
@section('title', 'Create Image Advertisement')
@section('dashboard-title', 'Create Image Advertisement')
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="bi bi-megaphone me-2"></i>Add Image Advertisement</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('super-admin.image-advertisements.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle me-1"></i> Create Advertisement
                            </button>
