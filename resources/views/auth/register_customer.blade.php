                    ...
                    <form method="POST" action="{{ route('register.customer.submit') }}">
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label" for="accepted_terms">
                                I accept the <a href="{{ route('pages.terms') }}" target="_blank" class="text-warning">Terms & Conditions</a> and <a href="{{ route('pages.customer_rights') }}" target="_blank" class="text-warning">Customer Code of Conduct</a>.
                            </label>
